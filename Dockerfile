...
RUN apt update&&apt install -y build-essential git python curl&&git clone https://github.com/makerdao/mcd-cdp-portal.git&&cd mcd-cdp-portal&&git checkout master&&yarn&&yarn now-build
